import InvariantError from './InvariantError.mjs';

const DomainErrorTranslator = {
  translate: (error: Error): Error => DomainErrorTranslator._dirs[error.message] || error,
  _dirs: {
    ...
    'COMMENT_LIKE.NOT_CONTAIN_NEEDED_PROPERTY': new InvariantError('tidak dapat memberikan like pada comment karena properti yang dibutuhkan tidak ada'),
    'COMMENT_LIKE.NOT_MEET_DATA_TYPE_SPECIFICATION': new InvariantError('tidak dapat memberikan like pada comment karena tipe data tidak sesuai'),
  } as Record<string, InvariantError>,
};
